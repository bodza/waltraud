 ...
 * The only assumption that the code makes with regard to this this table is that it is order by error number.
 *
 * The size of this table is quite large.
 * Its size can be reduced by eliminating some of the more obscure error strings.
 */
