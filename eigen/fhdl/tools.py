from ..fhdl.structure import _Assign, Case, Cat, _Fragment, If, _Part, ResetSignal, Signal, _Slice, SPECIAL_INOUT, SPECIAL_INPUT, value_bits_sign
from ..fhdl.visit import NodeVisitor, NodeTransformer
