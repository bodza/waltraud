from ..fhdl.decorators import ModuleTransformer
from ..util.misc import gcd_multiple
from ..fhdl.specials import Memory, _MemoryPort, WRITE_FIRST, NO_CHANGE
from ..fhdl.structure import If, log2_int, Signal
