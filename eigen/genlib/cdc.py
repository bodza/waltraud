...
from ..fhdl.decorators import ClockDomainsRenamer
from ..fhdl.module import Module
from ..fhdl.specials import Special, Memory
from ..fhdl.structure import If, Signal, SPECIAL_INPUT, SPECIAL_OUTPUT, value_bits_sign, wrap

from ..genlib.misc import WaitTimer
from ..genlib.resetsync import AsyncResetSynchronizer
...
class BlindTransfer(Module):
    ...
    def __init__(self, idomain, odomain, data_width=0):
        ...
        if data_width:
            ...
            self.specials += MultiReg(bxfer_data, self.data_o, odomain=odomain)
