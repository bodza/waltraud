...
from ..fhdl.module import Module, FinalizeError
from ..fhdl.structure import _ArrayProxy, Case, Cat, Constant, If, _Part, Signal, _Slice, _Statement, value_bits_sign
from ..fhdl.visit import NodeTransformer
